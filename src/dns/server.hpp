...
namespace srouter::dns
{
    ...
    class Server
    {
      ...
      public:
        ...
        explicit Server(quic::Loop& loop, srouter::DnsConfig conf, unsigned int netif_index);
        ...
        virtual std::shared_ptr<PacketSource> make_packet_source_on(
            const quic::Address& bindaddr, const srouter::DnsConfig& conf);
